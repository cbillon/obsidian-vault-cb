...
tags:
  - bayes
---
[outil](https://static.laszlokorte.de/stochastic/)
...
[Bayes theorem](https://en.wikipedia.org/wiki/Bayes%27_theorem "Bayes theorem on wikipedia") corresponds to the conversion of the side lengths of one rectangle to the side lengths of the other same colored rectangle.