...
tags:
  ...
  - volumes
---
# Everything about Docker volumes[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#everything-about-docker-volumes "Permalink to this heading")

## Intro[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#intro "Permalink to this heading")
...
You should never handle files on a volume directly without entering a container, unless there is an emergency, and even then, only at your own risk.
...
## Where does Docker store data?[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#where-does-docker-store-data "Permalink to this heading")
...
You can change it in the [daemon configuration](https://docs.docker.com/engine/reference/commandline/dockerd/#on-linux), so if it is changed on your system, you will need to replace this folder in the examples I show. To find out what the data root is, run the following command:
...
## What is a Docker volume?[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#what-is-a-docker-volume "Permalink to this heading")
...
## Custom volume path[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#custom-volume-path "Permalink to this heading")

### Custom volume path overview[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#custom-volume-path-overview "Permalink to this heading")
...
Even the the above example assumed Linux, custom volume path would work on other operating systems as well, since Docker Desktop would mount the required path into the virtual machine.
...
### Avoid accidental data loss on volumes[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#avoid-accidental-data-loss-on-volumes "Permalink to this heading")
...
## Docker CE volumes on Linux[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-ce-volumes-on-linux "Permalink to this heading")
...
So you can find the local default volumes under `/var/lib/docker/volumes` if you didn’t change the [data root](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-data-root). For the sake of simplicity of the commands, I will keep using the default path.
...
When you use [rootless Docker](https://docs.docker.com/engine/security/rootless/), the Docker data root will be in your user’s home.

$HOME/.local/share/docker

## Docker Desktop volumes[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-desktop-volumes "Permalink to this heading")
...
### Docker Desktop volumes on macOS[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-desktop-volumes-on-macos "Permalink to this heading")
...
### Docker Desktop volumes on Windows[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-desktop-volumes-on-windows "Permalink to this heading")

Docker Desktop on Windows allows you to switch between Linux containers and Windows containers.

[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133432&authkey=%21AG_OMIggB6CmAJI&width=687&height=372](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133432&authkey=%21AG_OMIggB6CmAJI&width=687&height=372)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133432&authkey=%21AG_OMIggB6CmAJI&width=687&height=372) [![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133431&authkey=%21AOgI2KQ2PKdvU4A&width=762&height=372](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133431&authkey=%21AOgI2KQ2PKdvU4A&width=762&height=372)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133431&authkey=%21AOgI2KQ2PKdvU4A&width=762&height=372)
...
#### Linux containers[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#linux-containers "Permalink to this heading")
...
[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133430&authkey=%21AD5cDeb5_HcLF2M&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133430&authkey=%21AD5cDeb5_HcLF2M&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133430&authkey=%21AD5cDeb5_HcLF2M&width=660)

Warning

WSL2 let’s you edit files more easily even if the files are owned by root on the volume, so do it at your own risk. My recommendation is using it only for debugging.

#### Windows Containers[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#windows-containers "Permalink to this heading")
...
This folder is hidden by default, so if you want to open it, just type the path manually in the navigation bar, or enable hidden folders on Windows 11 (works differently on older Windows):

Menu bar » View » Show » Hidden Items

[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133427&authkey=%21APhiCiUQGq72UQM&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133427&authkey=%21APhiCiUQGq72UQM&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133427&authkey=%21APhiCiUQGq72UQM&width=660)

Then try to open the folder called “Docker” which gives you a prompt to ask for permission to access to folder.

[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133428&authkey=%21AKUGZd-hYWHwoqg&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133428&authkey=%21AKUGZd-hYWHwoqg&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133428&authkey=%21AKUGZd-hYWHwoqg&width=660)

and then try to open the folder called “volumes” which will do the same.

[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133429&authkey=%21AALcQVxwylnJ_kc&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133429&authkey=%21AALcQVxwylnJ_kc&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133429&authkey=%21AALcQVxwylnJ_kc&width=660)

After that you can open any Windows container volume from Windows explorer.

### Docker Desktop volumes on Linux[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-desktop-volumes-on-linux "Permalink to this heading")
...
The default is usually rootful Docker CE and the other too are obvious. Only the rootful Docker CE needs to run as root, so if you want to interact with Docker Desktop, don’t make the mistake of running the docker commands with sudo:
...
## Editing files on volumes[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#editing-files-on-volumes "Permalink to this heading")

### The danger of editing volume contents outside a container[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#the-danger-of-editing-volume-contents-outside-a-container "Permalink to this heading")
...
### View and Edit files through Docker Desktop[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#view-and-edit-files-through-docker-desktop "Permalink to this heading")
...
[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133436&authkey=%21ADM4u1wAPqL8rmU&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133436&authkey=%21ADM4u1wAPqL8rmU&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133436&authkey=%21ADM4u1wAPqL8rmU&width=660)

Click on the three dots in the line of the container in which you want to browse files

[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133437&authkey=%21ADNIjONXytcFUHs&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133437&authkey=%21ADNIjONXytcFUHs&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133437&authkey=%21ADNIjONXytcFUHs&width=660)

Go to a file that you want to edit

[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133438&authkey=%21ACErzlwcIzzwuDI&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133438&authkey=%21ACErzlwcIzzwuDI&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133438&authkey=%21ACErzlwcIzzwuDI&width=660)

Note

Notice that Docker Desktop shows you whether the files are modified on the container’s filesystem, or you see a file on a volume.
...
[![https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133439&authkey=%21AH9h0I_2XVC71eU&width=660](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133439&authkey=%21AH9h0I_2XVC71eU&width=660)](https://onedrive.live.com/embed?resid=9d670019d6697cb6%2133439&authkey=%21AH9h0I_2XVC71eU&width=660)
...
Edit only source code that you mount into the container during development or [Use Compose watch](https://docs.docker.com/compose/file-watch/) to update the files when you edit them, but let the data be handled only by the processes in the containers.
...
### Container based dev environments[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#container-based-dev-environments "Permalink to this heading")

#### Docker Desktop Dev environment[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#docker-desktop-dev-environment "Permalink to this heading")
...
#### Visual Studio Code remote development[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#visual-studio-code-remote-development "Permalink to this heading")
...
#### Visual Studio Code dev containers[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#visual-studio-code-dev-containers "Permalink to this heading")
...
## Conclusion[](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#conclusion "Permalink to this heading")
