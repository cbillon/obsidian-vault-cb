---
link: https://www.lindsaykwardell.com/blog/setting-up-elm-in-2022/
site: Lindsay Wardell
excerpt: Programmer, writer, mother. She/Her. Interested in Vue, Typescript, Node.js, and Elm.
slurped: 2024-08-21T17:38
...
![Elm reactor, showing current files in the src folder, source directories, and dependencies](https://www.lindsaykwardell.com/blog/elm-reactor.png)
...
![The Elm tooling extension in VS Code](https://www.lindsaykwardell.com/blog/elm-vs-code.png)
...
![Pull in typed Elm data to your pages. Whether your data is coming from markdown files, APIs, a CMS, or all of the above, elm-pages lets you pull in just the data you need for a page. No loading spinners, no Msg or update logic, just define your data and use it in your view.](https://www.lindsaykwardell.com/blog/elm-pages-image.png)
...
![Lindsay Wardell](https://www.lindsaykwardell.com/lindsay.jpg)

Hi, I'm Lindsay Wardell!

I am a programmer, writer, and mother. I work as a Senior Software Engineer at [Khan Academy](https://khanacademy.org/). I write and talk about Elm, Vue, Vite, and other tools that I enjoy learning about and using.