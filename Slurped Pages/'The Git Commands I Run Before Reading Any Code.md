...
byline: '"Ally Piechowski"'
site: Ally Piechowski
date: Invalid date
excerpt: '"Five git commands that tell you where a codebase hurts before you
  open a single file. Churn hotspots, bus factor, bug clusters, and crisis
  patterns."'
slurped: 2026-04-08T15:04
...
- [development](https://piechowski.io/tags/development)
- [git](https://piechowski.io/tags/git)
...
A [2005 Microsoft Research study](https://www.microsoft.com/en-us/research/publication/use-of-relative-code-churn-measures-to-predict-system-defect-density/) found churn-based metrics predicted defects more reliably than complexity metrics alone. I take the top 5 files from this list and cross-reference them against the bug hotspot command below. A file that’s high-churn _and_ high-bug is your single biggest risk.
