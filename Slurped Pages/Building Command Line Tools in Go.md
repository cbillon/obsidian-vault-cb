---
link: https://jogendra.dev/building-command-line-tools-in-go
byline: Jogendra
site: Jogendra
date: 2020-07-05T02:00
excerpt: An example post about building command line tools in golang using cobra
tags:
  - go
  - cli
  - cobra
slurped: 2025-10-18T16:23
...
A package named **cmd** is created which contains all of your commands files. `main.go` is the entry point of your tool, it export _cmd_ package and run `Execute()` func from `cmd/root.go` which execute the root command (base command of your tool, `bookmark` in this example). `rootCmd` represents the base command when called without any subcommands.
...
![bookmark-cli-subcommand](https://user-images.githubusercontent.com/20956124/86530983-1bb23300-bedb-11ea-9906-b9ad5ec5043e.png)
