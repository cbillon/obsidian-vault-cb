---
link: https://cekrem.github.io/posts/clean-architecture-and-plugins-in-go/
byline: Christian Ekrem
site: cekrem.github.io
date: 2025-01-07T01:00
excerpt: Let's make Dependency Inversion and other SOLID principles Great Again™
tags:
  - solid
  - dependency
slurped: 2025-10-18T11:51
...
**Update: this has become a series, the next entry can be found here: [Interface Segregation: Why Your Interfaces Should Be Small and Focused](app://obsidian.md/posts/interface-segregation-in-practice/)**

I’ve lately enjoyed revisiting the [SOLID Design Principles](app://en.wikipedia.org/wiki/SOLID). In the world of software architecture, few principles have stood the test of time like these. I find the “Dependency Inversion Principle” particularly interesting, as it’s one of the few that are either forgotten in modern applications, or drowned in so much over-engineering that the cost/benefit equation is offset anyways.
...
## Understanding the Landscape [Link to heading](#understanding-the-landscape)
...
## Clean Architecture in Practice [Link to heading](#clean-architecture-in-practice)
...
### The Core Domain [Link to heading](#the-core-domain)
...
### Plugin Implementation [Link to heading](#plugin-implementation)
...
## Dependency Inversion in Action [Link to heading](#dependency-inversion-in-action)
...
## The Plugin System at Work [Link to heading](#the-plugin-system-at-work)
...
## Applying This to APIs [Link to heading](#applying-this-to-apis)
...
## Build System Integration [Link to heading](#build-system-integration)
