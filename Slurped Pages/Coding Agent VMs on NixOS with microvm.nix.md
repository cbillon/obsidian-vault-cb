...
excerpt: "I have come to appreciate coding agents to be valuable tools for
  working with computer program code in any capacity, such as learning about any
  program’s architecture, diagnosing bugs or developing proofs of concept.
  Depending on the use-case, reviewing each command the agent wants to run can
  get tedious and time-consuming very quickly. To safely run a coding agent
  without review, I wanted a Virtual Machine (VM) solution where the agent has
  no access to my personal files and where it’s no big deal if the agent gets
  compromised by malware: I can just throw away the VM and start over."
slurped: 2026-04-08T14:47
title: Coding Agent VMs on NixOS with microvm.nix
---

Table of contents

- [See also](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#see-also)
- [Setting up microvm.nix](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#setting-up-microvmnix)
    - [Step 1: network prep](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#step-1-network-prep)
    - [Step 2: `flake.nix`](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#step-2-flakenix)
    - [Step 3: `microvm.nix`](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#step-3-microvmnix)
    - [Step 4: `microvm-base.nix`](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#step-4-microvm-basenix)
    - [Step 5: `microvm-home.nix`](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#step-5-microvm-homenix)
    - [Step 6: `goprotobuf.nix`](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#step-6-goprotobufnix)
    - [Running the VM](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#running-the-vm)
- [Creating VMs with Claude](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#creating-vms-with-claude)
- [Replicating this setup with Claude Code](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#replicating-this-setup-with-claude-code)
- [Conclusion](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/#conclusion)
...
If you haven’t heard of NixOS before, check out [the NixOS Wikipedia page](https://en.wikipedia.org/wiki/NixOS) and [nixos.org](https://nixos.org/). I [spoke about why I switched to Nix in 2025](https://michael.stapelberg.ch/talks/#2025) and have published a [few blog posts about Nix](https://michael.stapelberg.ch/posts/tags/nix/).
...
[![Claude Code in “bypass permissions” mode](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/2026-01-28-neofetch-featured_hu_d06e7aa7176833b3.png "Claude Code in “bypass permissions” mode")](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/2026-01-28-neofetch-featured.png)
...
> please set up a microvm for Debian Code Search (dcs). see ~/dcs for the source code (but clone from [https://github.com/Debian/dcs](https://github.com/Debian/dcs))
...
> - /home/michael/microvm/dcs/dcs/ - Cloned repository from [https://github.com/Debian/dcs](https://github.com/Debian/dcs)
> 
...
> read [https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/](https://michael.stapelberg.ch/posts/2026-02-01-coding-agent-microvm-nix/) — I want the exact same setup in my midna NixOS configuration please!
