---
link: https://moodledev.io/docs/5.3/guides/composer
excerpt: How to make your Moodle plugin available via Composer, and developer
  tips for working with Composer-based Moodle sites.
slurped: 2026-08-23T14:30
title: Composer support for plugins | Moodle Developer Resources
---
...
## Making your plugin available via Composer[​](#making-your-plugin-available-via-composer "Direct link to Making your plugin available via Composer")

### Adding a composer.json[​](#adding-a-composerjson "Direct link to Adding a composer.json")
...
```
{    "name": "myplugin/moodle-block_myblock",    "description": "A description of my Moodle block plugin",    "type": "moodle-block",    "require": {        "moodle/moodle": "^5.2",        "moodle/composer-installer": "*"    },    "license": "GPL-3.0-or-later"}
```
...
### Publishing to Packagist[​](#publishing-to-packagist "Direct link to Publishing to Packagist")
...
## Development tips[​](#development-tips "Direct link to Development tips")

### Creating a development Moodle site[​](#creating-a-development-moodle-site "Direct link to Creating a development Moodle site")
...
```
cd [yourlocation]composer require "moodle/moodle:~5.2.0"
```

To install a plugin from Packagist:

```
cd [yourlocation]composer require myplugin/moodle-block_myblock
```

### Developing a plugin with a local path repository[​](#developing-a-plugin-with-a-local-path-repository "Direct link to Developing a plugin with a local path repository")
...
composer.json (Moodle site root)

```
{    "repositories": [        {            "type": "path",            "url": "/path/to/your/local/moodle-block_myblock",            "options": {                "symlink": false            }        }    ],    "require": {        "moodle/composer-installer": "*",        "myplugin/moodle-block_myblock": "*"    }}
```
...
### Declaring dependencies[​](#declaring-dependencies "Direct link to Declaring dependencies")
...
composer.json with Moodle package dependencies

```
{    "name": "myplugin/moodle-block_myblock",    "type": "moodle-block",    "require": {        "moodle/moodle": "^5.2",        "moodle/composer-installer": "*",        "abgreeve/moodle-block_stash": "^5.2"    },    "license": "GPL-3.0-or-later"}
```
...
- [`composer.json`](app://obsidian.md/docs/5.3/apis/commonfiles#composerjson) — common file reference for Moodle plugins
