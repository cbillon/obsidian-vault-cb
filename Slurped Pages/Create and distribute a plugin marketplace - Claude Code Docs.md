---
link: https://code.claude.com/docs/en/plugin-marketplaces#create-the-marketplace-file
site: Claude Code Docs
excerpt: Build and host plugin marketplaces to distribute Claude Code extensions across teams and communities.
slurped: 2026-01-26T19:27
