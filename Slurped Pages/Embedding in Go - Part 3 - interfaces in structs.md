---
link: https://eli.thegreenplace.net/2020/embedding-in-go-part-3-interfaces-in-structs/
excerpt: "This post is part 3 in a series describing the kinds of embedding Go supports:"
slurped: 2025-11-09T07:59
title: "Embedding in Go: Part 3 - interfaces in structs"
tags:
  - go
  - structs
---
...
It first attempts to read from r using the readFrom method, which is OS specific. On Linux, for example, it uses the [copy_file_range](https://man7.org/linux/man-pages/man2/copy_file_range.2.html) syscall for very fast copying between two files, directly in the kernel.
