...
- `name` : nom du workflow, qui sera également visible sur l'interface Github (comme dans [https://github.com/actions/runner/actions](https://github.com/actions/runner/actions))
