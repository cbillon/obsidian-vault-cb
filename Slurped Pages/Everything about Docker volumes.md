---
link: https://dev.to/rimelek/everything-about-docker-volumes-1ib0#editing-files-on-volumes
byline: Ákos Takács
site: DEV Community
date: 2024-01-07T21:54
excerpt: Intro   "Where are the Docker volumes?" This question comes up a lot on the Docker Forum....
twitter: https://twitter.com/@
tags:
  - docker
  - volumes
slurped: 2025-11-26T13:10
title: Everything about Docker volumes
---

## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#intro)Intro

"Where are the Docker volumes?" This question comes up a lot on the [Docker Forum](https://forums.docker.com/). There is no problem with curiosity, but this is usually asked when someone wants to edit or at least read files directly on the volume from a terminal or an IDE, but not through a container. So I must start with a statement:
...
Why I am saying it, you will understand if you read the next sections. Although the original goal with this tutorial was to explain where the volumes are, it is hard to talk about it without understanding what the volumes are and what different options you have when using volumes. As a result of that, by reading this tutorial, you can learn basically everything about the local volumes, but you can also search for volume plugins on [Docker Hub](https://hub.docker.com/).

## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#table-of-contents)Table of contents

- [Where does Docker store data?](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#where-does-docker-store-data)
- [What is a Docker volume](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#what-is-a-docker-volume)
- [Custom volume path](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#custom-volume-path)
    - [Custom volume path overview](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#custom-volume-path-overview)
    - [Avoid accidental data loss on volumes](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#avoid-accidental-data-loss-on-volumes)
- [Docker CE volumes on Linux](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-ce-volumes-on-linux)
- [Docker Desktop volumes](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes)
    - [Docker Desktop volumes on macOS](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes-on-macos)
    - [Docker Desktop volumes on Windows](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes-on-windows)
        - [Switching between Linux and Windows containers](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#switching-between-linux-and-windows-containers)
        - [Linux containers](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#linux-containers)
        - [Windows containers](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#windows-containers)
    - [Docker Desktop volumes on Linux](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes-on-linux)
- [Editing files on volumes](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#editing-files-on-volumes)
    - [The danger of editing volume contents outside a container](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#the-danger-of-editing-volume-contents-outside-a-container)
    - [View and edit files htrough Docker Desktop](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#view-and-edit-files-through-docker-desktop)
    - [Container based dev environments](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#container-based-dev-environments)
        - [Docker Desktop Dev environment](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-dev-environment)
        - [Visual Studio Code remote development](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#visual-studio-code-remote-development)
        - [Visual Studio Code dev containers](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#visual-studio-code-dev-containers)
- [Conclusion](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#conclusion)

## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#where-does-docker-store-data)Where does Docker store data?

[» Back to table of contents «](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#table-of-contents)
...
[Docker CE](https://learn-docker.it-sziget.hu/en/latest/pages/intro/getting-started.html#concept-docker-ce) is the community edition of Docker and can run directly on Linux. It has a data root directory, which is the following by default:  
...
## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#what-is-a-docker-volume)What is a Docker volume?

[» Back to table of contents «](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#table-of-contents)

For historical reasons, the concept of volumes can be confusing. There is a [page in the documentation](https://docs.docker.com/storage/volumes/) which describes what volumes are, but when you see a Compose file or a docker run command, you see two types of volumes, but only one of them is actually a volume.
...
Did I just define a volume? No. It is a [bind mount](https://docs.docker.com/storage/bind-mounts/). Let’s just use the long syntax:  
...
You can find this and other parameters in the [documentation of volumes in a compose file](https://docs.docker.com/compose/compose-file/05-services/#volumes). Scroll down to the "Long syntax" to read about "nocopy".

## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#custom-volume-path)Custom volume path

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#custom-volume-path-overview)Custom volume path overview
...
**Note:** _Even the the above example assumed Linux, custom volume path would work on other operating systems as well, since Docker Desktop would mount the required path into the virtual machine._
...
### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#avoid-accidental-data-loss-on-volumes)Avoid accidental data loss on volumes
...
## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-ce-volumes-on-linux)Docker CE volumes on Linux
...
## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes)Docker Desktop volumes
...
Parts of what I show here and more can be found in my presentation which I gave on the 6th Docker Community All-Hands. Tyler Charboneau wrote a [blog post](https://www.docker.com/blog/how-to-fix-and-debug-docker-containers-like-a-superhero/) about it, but you can also find [the video](https://www.youtube.com/watch?v=8zVOCnfkycY) in the blog post.

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes-on-macos)Docker Desktop volumes on macOS
...
### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes-on-windows)Docker Desktop volumes on Windows

#### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#switching-between-linux-and-windows-containers)Switching between Linux and Windows containers

[» Back to table of contents «](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#table-of-contents)

Docker Desktop on Windows allows you to switch between Linux containers and Windows containers.

[![Click on the Docker icon](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F58pq57r9430ix57fmd7o.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F58pq57r9430ix57fmd7o.png)

[![Switch to Linux containers](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Flnm8bcxzkisqy618tih5.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Flnm8bcxzkisqy618tih5.png)
...
#### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#linux-containers)Linux containers
...
[![wsl.localhost path](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fdrd1z02n527nr5j3h8ts.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fdrd1z02n527nr5j3h8ts.png)

**Warning:** _WSL2 let’s you edit files more easily even if the files are owned by root on the volume, so do it at your own risk. My recommendation is using it only for debugging._

#### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#windows-containers)Windows containers
...
[![Unhide hidden folders](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fqtiul2vp8l46snwm94a1.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fqtiul2vp8l46snwm94a1.png)

Then try to open the folder called “Docker” which gives you a prompt to ask for permission to access to folder.

[![Get access to the Docker folder](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Ftfn78oi94xyplionk4rb.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Ftfn78oi94xyplionk4rb.png)

and then try to open the folder called “volumes” which will do the same.

[![Get access to the volumes folder](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F0cqzr4swdh45wy1quogs.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F0cqzr4swdh45wy1quogs.png)

After that you can open any Windows container volume from Windows explorer.

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-volumes-on-linux)Docker Desktop volumes on Linux
...
## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#editing-files-on-volumes)Editing files on volumes

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#the-danger-of-editing-volume-contents-outside-a-container)The danger of editing volume contents outside a container
...
> **Any operation inside the Docker data root is dangerous, and can break your Docker completely, or cause problems that you don’t immediately recognize, so you should never edit files without mounting the volume into a container, except if you defined a [custom volume path](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html#custom-volume-path) so you don’t have to go into the Docker data root.**
> 
...
### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#view-and-edit-files-through-docker-desktop)View and Edit files through Docker Desktop
...
[![Containers tab](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fp1z5taj1eh7ydyl2fcdv.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fp1z5taj1eh7ydyl2fcdv.png)

Click on the three dots in the line of the container in which you want to browse files

[![Container menu](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fe0127av51gtokztppjki.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fe0127av51gtokztppjki.png)

Go to a file that you want to edit

[![File browser](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Ff8cyv667b01jppa3dr51.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Ff8cyv667b01jppa3dr51.png)

**Note:** _Notice that Docker Desktop shows you whether the files are modified on the container’s filesystem, or you see a file on a volume._
...
[![File menu](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fy43na8ynv4g4b7rf2vt4.png)](https://media2.dev.to/dynamic/image/width=800%2Cheight=%2Cfit=scale-down%2Cgravity=auto%2Cformat=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fy43na8ynv4g4b7rf2vt4.png)
...
## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#container-based-dev-environments)Container based dev environments

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#docker-desktop-dev-environment)Docker Desktop Dev environment
...
More information in the [documentation of the Dev environment](https://docs.docker.com/desktop/dev-environments/)

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#visual-studio-code-remote-development)Visual Studio Code remote development
...
More information is in the [documentation of VSCode about containers](https://code.visualstudio.com/docs/containers/overview).

### [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#visual-studio-code-dev-containers)Visual Studio Code dev containers
...
More information in the [documentation of VSCode about dev containers](https://code.visualstudio.com/docs/devcontainers/containers).

## [](https://dev.to/rimelek/everything-about-docker-volumes-1ib0#conclusion)Conclusion
...
If you enjoyed this tutorial, I also recommend reading about [Volume-only Compose projects](https://dev.to/rimelek/docker-compose-volumes-volume-only-projects-and-init-containers-5468).

You can also subscribe to my [YouTube channel](https://www.youtube.com/@akos.takacs) if you want to be notified about my videos as well. If you are interested in Hungarian contents, I have a [channel for you too](https://www.youtube.com/@itsziget).
...
[https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html](https://learn-docker.it-sziget.hu/en/latest/pages/advanced/volumes.html)