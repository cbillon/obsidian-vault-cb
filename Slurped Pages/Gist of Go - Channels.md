---
link: https://antonz.org/go-concurrency/channels/
byline: Anton Zhiyanov
site: "@ohmypy"
excerpt: A multi-purpose concurrency tool.
twitter: https://twitter.com/@ohmypy
slurped: 2025-11-11T09:50
title: "Gist of Go: Channels"
---
...
We've learned how to launch [goroutines](app://obsidian.md/goroutines/) and pass data through channels. But channels have many more interesting features. Let's dive in!

- [End-of-data signaling](#end-of-data-signaling)
...
- [Semaphore](#semaphore)
- [Closing a buffered channel](#closing-a-buffered-channel)
...
// say prints each word of a phrase.
func say(sema <-chan struct{}, phrase string) {
	for _, word := range strings.Fields(phrase) {
...
In the next chapter, we'll discuss [pipelines](app://obsidian.md/pipelines/).
