---
link: https://antonz.org/go-concurrency/pipelines/
byline: Anton Zhiyanov
site: "@ohmypy"
excerpt: Compose concurrent pipelines from independent blocks.
...
We've learned how to use [goroutines](app://obsidian.md/goroutines/) and [channels](app://obsidian.md/channels/), now let's see how to assemble them into concurrent pipelines!

- [Leaked goroutine](#leaked-goroutine)
- [Cancel channel](#cancel-channel)
- [Cancel vs. done](#cancel-vs-done)
- [Merging: sequentially](#merging-channels-sequentially)
- [Merging: concurrently](#merging-channels-concurrently)

- [Merging: select](#merging-channels-select)
- [Pipeline](#pipeline)
...
In the next chapter, we'll work with [time](app://obsidian.md/time/).
