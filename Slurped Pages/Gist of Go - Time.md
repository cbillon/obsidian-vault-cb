---
link: https://antonz.org/go-concurrency/time/
byline: Anton Zhiyanov
site: "@ohmypy"
excerpt: Techniques for handling time in concurrent programs.
twitter: https://twitter.com/@ohmypy
slurped: 2025-11-11T09:51
title: "Gist of Go: Time"
---
...
See the [Resetting timers in Go](app://obsidian.md/timer-reset/) article for details if you are interested.
...
In the next chapter, we'll work with [context](app://obsidian.md/context/).
