...
excerpt: >-
  I use Git a lot, even writing this article i will commit text few times.
  There&rsquo;s a set of aliases I rely on daily and they&rsquo;re first I add
  in new place.

  Some Git commands are unnecessarily verbose. You can make your life much
  easier with bash-completions, but if you write it tens of times per day,
  it&rsquo;s anyway a lot of typing&hellip; and I&rsquo;m a lazy man &#x1f604;

  Simple status/log checks git s s = status --short --branch --untracked-files
