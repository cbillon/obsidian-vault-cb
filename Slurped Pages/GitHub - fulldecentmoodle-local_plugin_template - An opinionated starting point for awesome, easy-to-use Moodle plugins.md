---
link: https://github.com/fulldecent/moodle-local_plugin_template
site: GitHub
excerpt: An opinionated starting point for awesome, easy-to-use Moodle plugins - fulldecent/moodle-local_plugin_template
twitter: https://twitter.com/@github
slurped: 2026-09-03T10:19
title: "GitHub - fulldecent/moodle-local_plugin_template: An opinionated starting point for awesome, easy-to-use Moodle plugins"
tags:
  - moodle
  - plugin
  - fulldecent
...
[](https://github.com/fulldecent/moodle-local_plugin_template#moodle-plugin-template)
...
[![File listing](https://github.com/fulldecent/moodle-local_plugin_template/raw/main/docs/images/project-files.png)](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/docs/images/project-files.png)

## Key features

[](https://github.com/fulldecent/moodle-local_plugin_template#key-features)

This template provides a structured, best-practice foundation for developing Moodle plugins, including:

- 📝 [Installation instructions](https://github.com/fulldecent/moodle-local_plugin_template#quick-start-playground) for developers and users of your module
- 🏃 [Some basic, dumb functionality](https://github.com/fulldecent/moodle-local_plugin_template#functional-examples) for a module that you can edit or remove
- 🔧 [Build system and CI/CD setup](https://github.com/fulldecent/moodle-local_plugin_template#high-five-plugin) using GitHub Actions
- 🌍 [Localization](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/lang) for all strings
- ✅ [Automated](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/.github/workflows) code style checks, unit testing
- 🆙 Your module [confirms compatibility](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/.github/workflows) with new Moodle versions, when published, with zero action from you

### Functional examples

[](https://github.com/fulldecent/moodle-local_plugin_template#functional-examples)
...
- **[Scheduled task](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/task/README.md)** to remove old records from the database
...
- **[Event logging](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/classes/event/README.md)** demonstrates how to log events in Moodle using the Events API

You can use these features as they are, modify them, or remove what you don’t need.

## Best practices and resources

[](https://github.com/fulldecent/moodle-local_plugin_template#best-practices-and-resources)

Below in the documentation for your new module, and also in [the database README](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/db/README.md), we cite specific other modules that we recognize as best practice. Such as using "production mode", which is not compliant with DRY.
...
[](https://github.com/fulldecent/moodle-local_plugin_template#how-to-make-your-own-plugin)
...
[](https://github.com/fulldecent/moodle-local_plugin_template#high-five-plugin)

Enable students to "high five" each other! Enhance engagement and community.

Supported Moodle versions: [![CI status](https://github.com/fulldecent/moodle-local_plugin_template/actions/workflows/ci.yml/badge.svg)](https://github.com/fulldecent/moodle-local_plugin_template/actions/workflows/ci.yml/badge.svg)

## Features

[](https://github.com/fulldecent/moodle-local_plugin_template#features)

### ✋ ​Admin can make a high five

[](https://github.com/fulldecent/moodle-local_plugin_template#hand-admin-can-make-a-high-five)

This page is only accessible to administrators.

[![](https://github.com/fulldecent/moodle-local_plugin_template/raw/main/docs/images/admin-high-five.webp)](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/docs/images/admin-high-five.webp)

_If you are running Moodle locally, see this live at [local/high_five/](http://localhost:8000/local/high_five/)._

### Users can make a high five from the dashboard [COMING SOON]

[](https://github.com/fulldecent/moodle-local_plugin_template#users-can-make-a-high-five-from-the-dashboard-coming-soon)

Access on your dashboard page at `Edit mode > Add block > High Five`.

[ IMAGE COMING SOON ]

_If you are running Moodle locally, see this live at [blocks/high_five/](http://localhost:8000/my/index.php)._

### Students can make a high five from inside a course [ COMING SOON ]

[](https://github.com/fulldecent/moodle-local_plugin_template#students-can-make-a-high-five-from-inside-a-course--coming-soon-)

Access on your course page at `[ INSTRUCTIONS COMING SOON ]`.

[ IMAGE COMING SOON ]

_If you are running Moodle locally, see this live at [ LINK COMING SOON ]._

### ⚙️ Site administration page

[](https://github.com/fulldecent/moodle-local_plugin_template#gear-site-administration-page)
...
[![](https://github.com/fulldecent/moodle-local_plugin_template/raw/main/docs/images/settings.webp)](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/docs/images/settings.webp)

_If you are running Moodle locally, see this live at [admin/settings.php?section=local_high_five](http://localhost:8000/admin/settings.php?section=local_high_five)._

## Quick start playground

[](https://github.com/fulldecent/moodle-local_plugin_template#quick-start-playground)

🏃 Run a Moodle playground site with _High Five_ on your own computer in under 5 minutes! Zero programming or Moodle experience required.
...
1. Install a Docker system:
    ...
    1. On macOS we currently recommend [OrbStack](https://orbstack.dev/). This is the only software which can install Moodle in under 5 minutes. We would prefer if an open source product can provide this experince, but none such exists. See [references](https://github.com/fulldecent/moodle-local_plugin_template#references) below if you may prefer another option.
...
3. Install the latest version of Moodle:
    ...
    _ℹ️ If you see the error "fatal: Remote branch MOODLE_X0Y_STABLE not found in upstream origin", please reread instruction in the code comment and try again._
    
    _These instructions include a workaround for [Moodle issue MDL-83812](https://tracker.moodle.org/browse/MDL-83812)._
...
5. Get and run Moodle Docker container (instructions adapted from [moodle-docker instructions](https://github.com/moodlehq/moodle-docker)):
    ...
    _ℹ️ If you see the error "Database tables already present; CLI installation cannot continue", please follow the "teardown" instructions below and then try again._
    
    _ℹ️ If you see the error "!!! Site is being upgraded, please retry later. !!!", and "Error code: upgraderunning…", please ignore the error and proceed._
    
    _These instructions include a workaround for [moodle-docker issue #307](https://github.com/moodlehq/moodle-docker/issues/307)._
    
6. 🌞 Now play with your server at [http://localhost:8000](http://localhost:8000/)
    
    1. Click the top-right to login.
    2. Your username is `admin` and your password is `test`.
    
    _ℹ️ If you see a bunch of stuff and "Update Moodle database now", then click that button and wait. On a M1 Mac with 8GB ram, we saw this take 5 minutes for the page to finish loading._
...
[](https://github.com/fulldecent/moodle-local_plugin_template#install)
...
[](https://github.com/fulldecent/moodle-local_plugin_template#updating-javascript)

_You only need these instructions if you contribute changes to this High Five plugin, specifically the functionality in JavaScript._
...
The end result is that your files in [amd/build](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/amd/build) will be updated, assuming you have made changes to your files in [amd/source](https://github.com/fulldecent/moodle-local_plugin_template/blob/main/amd/source).
...
[](https://github.com/fulldecent/moodle-local_plugin_template#setting-up-the-high-five-block-plugin)
...
[](https://github.com/fulldecent/moodle-local_plugin_template#contributing)

Please send PRs to our [main branch](https://github.com/fulldecent/moodle-local_plugin_template).

## References

[](https://github.com/fulldecent/moodle-local_plugin_template#references)
