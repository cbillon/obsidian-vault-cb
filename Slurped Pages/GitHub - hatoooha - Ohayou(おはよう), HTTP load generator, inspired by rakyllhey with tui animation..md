...
site: GitHub
excerpt: Ohayou(おはよう), HTTP load generator, inspired by rakyll/hey with tui
  animation. - hatoo/oha
twitter: https://twitter.com/@github
slurped: 2026-03-29T16:28
title: "GitHub - hatoo/oha: Ohayou(おはよう), HTTP load generator, inspired by
  rakyll/hey with tui animation."
---
...
[![demo](https://github.com/hatoo/oha/raw/master/demo.gif)](https://github.com/hatoo/oha/blob/master/demo.gif)

## Installation

[](https://github.com/hatoo/oha#installation)
...
You can enable experimental HTTP3 support by enabling the `http3` feature. This uses the [H3](https://github.com/hyperium/h3) library by the developers of Hyper. It will remain experimental as long as H3 is experimental. It currently depends on using `rustls` for TLS.

## Download pre-built binary

[](https://github.com/hatoo/oha#download-pre-built-binary)
...
[](https://github.com/hatoo/oha#on-arch-linux)

## On macOS (Homebrew)

[](https://github.com/hatoo/oha#on-macos-homebrew)

## On Windows (winget)

[](https://github.com/hatoo/oha#on-windows-winget)

## On Debian ([Azlux's repository](http://packages.azlux.fr/))

[](https://github.com/hatoo/oha#on-debian-azluxs-repository)
...
[](https://github.com/hatoo/oha#x-cmd-linux-macos-windows-wslgitbash)

You can install with [x-cmd](https://www.x-cmd.com/).

## Containerized

[](https://github.com/hatoo/oha#containerized)

### Official Docker image

[](https://github.com/hatoo/oha#official-docker-image)

[ghcr.io/hatoo/oha](https://github.com/hatoo/oha/pkgs/container/oha)

### Build image locally

[](https://github.com/hatoo/oha#build-image-locally)
...
[](https://github.com/hatoo/oha#platform)
...
[](https://github.com/hatoo/oha#usage)
...
[](https://github.com/hatoo/oha#output)

By default `oha` outputs a text summary of the results.

`oha` prints JSON summary output when `--output-format json` option is set. The schema of JSON output is defined in [schema.json](https://github.com/hatoo/oha/blob/master/schema.json).

When `--output-format csv` is used result of each request is printed as a line of comma separated values.

## Tips

[](https://github.com/hatoo/oha#tips)

## Stress test in more realistic condition

[](https://github.com/hatoo/oha#stress-test-in-more-realistic-condition)
...
[](https://github.com/hatoo/oha#burst-feature)
...
In this particular scenario, every 2 seconds, 4 requests will be processed, and after 6s the total of 10 requests will be processed. _NOTE: If you don't set `--burst-rate` option, the amount is default to 1_

## Dynamic url feature

[](https://github.com/hatoo/oha#dynamic-url-feature)
...
[](https://github.com/hatoo/oha#urls-from-file-feature)
...
[](https://github.com/hatoo/oha#contribution)
