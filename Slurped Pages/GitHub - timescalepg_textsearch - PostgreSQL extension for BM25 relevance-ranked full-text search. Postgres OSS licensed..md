...
site: GitHub
excerpt: PostgreSQL extension for BM25 relevance-ranked full-text search. Postgres OSS licensed. - timescale/pg_textsearch
twitter: https://twitter.com/@github
slurped: 2026-04-03T19:12
title: "GitHub - timescale/pg_textsearch: PostgreSQL extension for BM25 relevance-ranked full-text search. Postgres OSS licensed."
tags:
  - postgresql
  - bm25
  - full_text-search
...
🚀 **Status**: v1.0.0 - Production ready. See [ROADMAP.md](https://github.com/timescale/pg_textsearch/blob/main/ROADMAP.md) for upcoming features.


## Historical note

[](https://github.com/timescale/pg_textsearch#historical-note)
...
[](https://github.com/timescale/pg_textsearch#postgresql-version-compatibility)

pg_textsearch supports PostgreSQL 17 and 18.

## Installation

[](https://github.com/timescale/pg_textsearch#installation)

### Pre-built Binaries

[](https://github.com/timescale/pg_textsearch#pre-built-binaries)

Download pre-built binaries from the [Releases page](https://github.com/timescale/pg_textsearch/releases). Available for Linux and macOS (amd64 and arm64), PostgreSQL 17 and 18.

### Build from Source

[](https://github.com/timescale/pg_textsearch#build-from-source)
...
[](https://github.com/timescale/pg_textsearch#getting-started)
...
[](https://github.com/timescale/pg_textsearch#querying)
...
[](https://github.com/timescale/pg_textsearch#verifying-index-usage)
...
[](https://github.com/timescale/pg_textsearch#filtering-with-where-clauses)
...
- **Post-filtering tradeoff**: The index returns top-k results _before_ filtering. If your WHERE clause eliminates most results, you may get fewer rows than requested. Increase LIMIT to compensate, then re-limit in application code.
...
This is similar to the [filtering behavior in pgvector](https://github.com/pgvector/pgvector?tab=readme-ov-file#filtering), where approximate indexes also apply filtering after the index scan.

## Indexing

[](https://github.com/timescale/pg_textsearch#indexing)
...
[](https://github.com/timescale/pg_textsearch#index-options)
...
[](https://github.com/timescale/pg_textsearch#data-types)

### bm25query

[](https://github.com/timescale/pg_textsearch#bm25query)
...
[](https://github.com/timescale/pg_textsearch#bm25query-functions)
...
[](https://github.com/timescale/pg_textsearch#performance)
...
[](https://github.com/timescale/pg_textsearch#parallel-index-builds)
...
[](https://github.com/timescale/pg_textsearch#performance-tuning)

#### Force-merging segments

[](https://github.com/timescale/pg_textsearch#force-merging-segments)
...
[](https://github.com/timescale/pg_textsearch#use-limit-with-order-by)
...
[](https://github.com/timescale/pg_textsearch#segment-compression)
...
[](https://github.com/timescale/pg_textsearch#postgres-settings-that-affect-index-builds)
...
[](https://github.com/timescale/pg_textsearch#pg_textsearch-gucs)
...
[](https://github.com/timescale/pg_textsearch#spill-thresholds)
...
[](https://github.com/timescale/pg_textsearch#monitoring)
...
[](https://github.com/timescale/pg_textsearch#examples)

### Basic Search

[](https://github.com/timescale/pg_textsearch#basic-search)
...
[](https://github.com/timescale/pg_textsearch#limitations)

### No Phrase Queries

[](https://github.com/timescale/pg_textsearch#no-phrase-queries)
...
[](https://github.com/timescale/pg_textsearch#no-expression-indexing)
...
[](https://github.com/timescale/pg_textsearch#no-built-in-faceted-search)
...
[](https://github.com/timescale/pg_textsearch#insertupdate-performance)
...
[](https://github.com/timescale/pg_textsearch#no-background-compaction)
...
[](https://github.com/timescale/pg_textsearch#partitioned-tables)
...
[](https://github.com/timescale/pg_textsearch#word-length-limit)
...
[](https://github.com/timescale/pg_textsearch#plpgsql-and-stored-procedures)
...
[](https://github.com/timescale/pg_textsearch#troubleshooting)
...
[](https://github.com/timescale/pg_textsearch#installation-notes)
...
[](https://github.com/timescale/pg_textsearch#reference)

### Index Options

[](https://github.com/timescale/pg_textsearch#index-options-1)
...
[](https://github.com/timescale/pg_textsearch#text-search-configurations)
...
[](https://github.com/timescale/pg_textsearch#development-functions)
