---
link: https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5
byline: Maurício Linhares
site: DEV Community
date: 2022-02-07T19:45
excerpt: Since its release in 1994, the Design Patterns book continues to be a seminal work in building...
twitter: https://twitter.com/@mauriciojr
tags:
  - go
slurped: 2025-11-09T10:44
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#builder)Builder
...
We could go complex with multiple headers, change the method, set a custom context, and it would still look clean and easy to read. That's the main advantage of using a builder to instantiate complex objects. You get to go as deep as needed but should still be allowed to create something with sane defaults quickly. While this builder follows the _fluent API_ style, it's not the only way to produce a builder, as long as you find a way to separate the parametrization from the creation of a complex object that would still be a builder (like using the function opts linked above). The main goal here is to make it easier to build complex objects correctly.

## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#abstract-factoryfactory-method)Abstract factory/factory method
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#adapter)Adapter
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#decorator)Decorator
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#facade)Facade
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#proxy)Proxy
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#chain-of-responsibility-and-command)Chain of responsibility and Command
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#iterator)Iterator
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#observer)Observer
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#strategy)Strategy
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#template-method)Template Method
...
## [](https://dev.to/mauriciolinhares/gof-design-patterns-that-still-make-sense-in-go-27k5#what-is-dead-may-never-die)What Is Dead May Never Die
