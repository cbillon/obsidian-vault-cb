---
link: https://www.kelche.co/blog/go/build/
byline: Kevin Kelche
excerpt: Learn the art of building Go programs with the go build command. In this article, we explore the `go build` command in detail.
tags:
  - golang
slurped: 2026-04-16T11:11
