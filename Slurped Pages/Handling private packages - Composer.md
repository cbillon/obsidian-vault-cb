---
link: https://getcomposer.org/doc/articles/handling-private-packages.md
excerpt: A Dependency Manager for PHP
slurped: 2025-12-14T17:09
title: Handling private packages - Composer
tags:
  - composer
---

## Private Packagist[#](https://getcomposer.org/doc/articles/handling-private-packages.md#private-packagist)
...
## Satis[#](https://getcomposer.org/doc/articles/handling-private-packages.md#satis)

Satis on the other hand is open source but only a static `composer` repository generator. It is a bit like an ultra-lightweight, static file-based version of packagist and can be used to host the metadata of your company's private packages, or your own. You can install it using [Composer](https://github.com/composer/satis?tab=readme-ov-file#run-from-source) or [Docker](https://github.com/composer/satis?tab=readme-ov-file#run-as-docker-container).

## Setup[#](https://getcomposer.org/doc/articles/handling-private-packages.md#setup)

For example let's assume you have a few packages you want to reuse across your company but don't really want to open-source. You would first define a Satis configuration: a json file that lists your curated [repositories](https://getcomposer.org/doc/05-repositories.md).

The default file name is satis.json but it could be anything you like.

Here is an example configuration, you see that it holds a few VCS repositories, but those could be any types of [repositories](https://getcomposer.org/doc/05-repositories.md). Then it uses `"require-all": true` which selects all versions of all packages in the repositories you defined.
...
### Partial Updates[#](https://getcomposer.org/doc/articles/handling-private-packages.md#partial-updates)
...
If you want to scan only the selected package and not all VCS repositories you need to declare a _name_ for all your package (this only work on VCS repositories type) :
...
## Usage[#](https://getcomposer.org/doc/articles/handling-private-packages.md#usage)
...
### Security[#](https://getcomposer.org/doc/articles/handling-private-packages.md#security)
...
### Authentication[#](https://getcomposer.org/doc/articles/handling-private-packages.md#authentication)

Authentication can be handled in [several different ways](https://getcomposer.org/doc/articles/authentication-for-private-packages.md).

### Downloads[#](https://getcomposer.org/doc/articles/handling-private-packages.md#downloads)
...
#### Options explained[#](https://getcomposer.org/doc/articles/handling-private-packages.md#options-explained)
...
#### prefix-url[#](https://getcomposer.org/doc/articles/handling-private-packages.md#prefix-url)
...
### Web outputs[#](https://getcomposer.org/doc/articles/handling-private-packages.md#web-outputs)
...
### Abandoned packages[#](https://getcomposer.org/doc/articles/handling-private-packages.md#abandoned-packages)
...
### Resolving dependencies[#](https://getcomposer.org/doc/articles/handling-private-packages.md#resolving-dependencies)
...
### Other options[#](https://getcomposer.org/doc/articles/handling-private-packages.md#other-options)
...
- `config`: optional, lets you define all config options from composer, except `archive-format` and `archive-dir` as the configuration is done through [archive](https://getcomposer.org/doc/articles/handling-private-packages.md#downloads) instead. See docs on [config schema](https://getcomposer.org/doc/06-config.md) for more details.
- `notify-batch`: optional, specify a URL that will be called every time a user installs a package. See [notify-batch](https://getcomposer.org/doc/05-repositories.md#notify-batch).

Found a typo? Something is wrong in this documentation? [Fork and edit](https://github.com/composer/composer/edit/main/doc/articles/handling-private-packages.md "Go to the docs to fork and propose updates (external link)") it!