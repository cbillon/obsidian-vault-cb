...
byline: Scott Chacon
site: GitButler
date: 2025-02-22T09:23
updated: 2025-02-22T09:23
excerpt: What `git config` settings should be defaults by now? Here are some settings that even the core developers change.
twitter: https://twitter.com/@gitbutler
tags:
  - git
  - configuration
slurped: 2025-11-02T11:22
...
For a video version of this post, check out our Bits and Booze episode
...
The [results](https://lore.kernel.org/git/60df97ed24687_34a92088a@natae.notmuch/) were very interesting, a rather concise list of 9 config settings and 3 aliases that the experiment participants more or less agreed should arguably be new defaults. Let's just take a look at the proposed config setting changes.
...
![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-21-at-08.04.03%402x.png)
...
![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-20-at-16.07.58%402x.png)

Ok, a little confusing. Here is what `histogram` would give us in the same scenario:

![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-20-at-16.08.28%402x.png)

It's a bit more clear here what's actually happened.

As recently as last year, Elijah (of our [Git Merge fame](https://www.youtube.com/watch?v=KXPmiKfNlZE)) suggested that [histogram or patience](https://lore.kernel.org/git/CABPp-BEmgOAj17DozyXNaf-9CawDic4uTpMbckef3+zHf7URqQ@mail.gmail.com/) might make better defaults, in addition to Felipe's Spring Cleaning suggestion of the same thing, but in reality it’s unlikely to get through the gauntlet anytime soon.
...
![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-20-at-16.14.15%402x.png)
...
![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-20-at-17.03.26%402x.png)
...
![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-20-at-17.01.54%402x.png)
...
![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-21-at-11.47.34%402x.png)

With the `merge.conflictStyle zdiff3` setting, it would look like this:

![](https://d2m1ukvwmu7gz4.cloudfront.net/images/images-2025-02-CleanShot-2025-02-21-at-11.48.36%402x.png)
...
There are lots of other ways to pimp your Git ride (aliases, cool external [pager](https://github.com/dandavison/delta) and [diff](https://github.com/so-fancy/diff-so-fancy) tools, things like that) but I thought it would be best to just stick to globally useful and relatively simple vanilla Git settings.
