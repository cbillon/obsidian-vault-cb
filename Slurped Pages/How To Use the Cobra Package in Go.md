---
link: https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go
byline: Goodnessuc
site: DigitalOcean
date: 2023-07-14T00:12
excerpt: In this tutorial, you’ll learn how to build CLIs in Go with the popular Cobra package. Then, you’ll build a CLI application that outputs the timezone in a specified location.
slurped: 2025-10-16T14:25
...
## [Introduction](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#introduction)
...
There are many tools you can use to build command-line applications in Go. For example, you can work with [Go’s built-in `flag` package](https://www.digitalocean.com/community/tutorials/how-to-use-the-flag-package-in-go) or resort to popular third-party packages like the Cobra package.
...
## [Prerequisites](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#prerequisites)

You’ll need to meet some requirements to fully grasp the concepts and follow this tutorial.

- You have a [recent version of the Go SDK](http://go.dev/dl) installed on your machine. Here’s [a walk-through tutorial](https://www.digitalocean.com/community/tutorial_collections/how-to-install-go) that you can follow to ease the installation process.
    
- You have experience working with the Go programming language. Review [this resource](https://www.digitalocean.com/community/tutorial_series/how-to-code-in-go) to start writing Go code.
    

## [Step 1 - Setting Up Your Development Environment](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#step-1-setting-up-your-development-environment)
...
## [Step 2 - Getting Started the Cobra Package](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#step-2-getting-started-the-cobra-package)
...
## [Step 3 - Retrieving the Time in a Timezone With the Time Package](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#step-3-retrieving-the-time-in-a-timezone-with-the-time-package)
...
Go’s built-in `time` package provides functionality for [working with different time zones](https://www.makeuseof.com/go-time-zones/). You can use the `LoadLocation` function of the `time` package to load the location data from a timezone string and access the time in the location with the `In` function of the `Now` function of the time package.
...
## [Step 4 - Adding Commands to Your Cobra Applications](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#step-4-adding-commands-to-your-cobra-applications)
...
Then run the `timezone` command with [a timezone string](https://en.wikipedia.org/wiki/List_of_tz_database_time_zones).
...
## [Step 5 - Adding Flags to Your Cobra Application](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#step-5-adding-flags-to-your-cobra-application)
...
## [Conclusion](https://www.digitalocean.com/community/tutorials/how-to-use-the-cobra-package-in-go#conclusion)
