---
link: https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/
byline: Gabor Koos
site: freeCodeCamp.org
date: 2025-09-12T23:44
excerpt: |-
  ...
  But in ...
twitter: https://twitter.com/@gkoos430
slurped: 2025-11-09T09:52
...
If arrays, slices, and maps are the _nouns_ of Go's collections, then the standard library helpers are the _verbs_. They let you do things with your data: sorting, searching, cloning, filtering, and transforming it in predictable and efficient ways.
...
- [Introduction](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-introduction)
    
- [Prerequisites](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-prerequisites)
    
- [Sorting & Searching Collections](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-sorting-amp-searching-collections)
    
    - [Sorting with sort](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-sorting-with-sort)
        
    - [Searching with](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-searching-with-sortsearch) [sort.Search](http://sort.search/)
        
    - [Sorting and Searching with slices](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-sorting-and-searching-with-slices)
        
    - [Practical Example: Sorting a Leaderboard](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-practical-example-sorting-a-leaderboard)
        
    - [Key Takeaways](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-key-takeaways)
        
- [Collection Helpers: slices & maps](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-collection-helpers-slices-amp-maps)
    
    - [Slice Helpers](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-slice-helpers)
        
    - [Practical Example: Filtering a Slice](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-practical-example-filtering-a-slice)
        
    - [Map Helpers](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-map-helpers)
        
    - [Practical Example: Combining Slices & Maps](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-practical-example-combining-slices-amp-maps)
        
    - [Performance Notes](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-performance-notes)
        
    - [Key Takeaways](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-key-takeaways-1)
        
- ["Classical" Data Structures with container/*](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-classical-data-structures-with-container)
    
    - [Doubly Linked Lists with container/list](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-doubly-linked-lists-with-containerlist)
        
    - [Priority Queues with container/heap](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-priority-queues-with-containerheap)
        
    - [Circular Buffers with container/ring](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-circular-buffers-with-containerring)
        
    - [Trade-offs compared to slices/maps](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-trade-offs-compared-to-slicesmaps)
        
    - [Key Takeaways](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-key-takeaways-2)
        
- [Specialized Utilities](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-specialized-utilities)
    
    - [Strings and Bytes as Collections](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-strings-and-bytes-as-collections)
        
    - [Reflection-Based Utilities](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-reflection-based-utilities)
        
    - [Key Takeaways](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-key-takeaways-3)
        
- [Case Study: A Simple Job Scheduler](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-case-study-a-simple-job-scheduler)
    
    - [Defining the Job Type](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-defining-the-job-type)
        
    - [Storing Jobs in a Map](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-storing-jobs-in-a-map)
        
    - [Snapshot Report with Slices](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-snapshot-report-with-slices)
        
    - [Priority Queue for Scheduling](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-priority-queue-for-scheduling)
        
    - [Putting It All Together](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-putting-it-all-together)
        
    - [Practice Challenge](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-practice-challenge)
        
- [Conclusion](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-conclusion)
    
- [Practice Challenge Solution](https://www.freecodecamp.org/news/how-to-work-with-collections-in-go-using-the-standard-library-helpers/#heading-practice-challenge-solution)
...
Slices of _ordered types_ can be queried for their minimum or maximum values, sorted, or searched using binary search.
