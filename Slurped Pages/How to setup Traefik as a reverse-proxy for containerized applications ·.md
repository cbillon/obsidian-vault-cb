---
link: https://myzopotamia.dev/traefik-reverse-proxy-with-containers#dynamic-config-files
byline: Radosław Skupnik
excerpt: Here’s how I use Traefik as a Reverse Proxy for my containerized applications hosted on Raspberry Pi.If you already k...
slurped: 2026-06-03T20:06
...
It’s quite simple - we define a _router_ (called _dummy_) which will fish for traffic coming to the hostname `raspberrypi5.local` and the path `/dummy` - that traffic will be directed to the _service_ (also called _dummy_, cause why not). That _service_ is defined below the _router_ and directs the traffic to `http://dummy:8080` - which will reach the **dummy** container at port `8080`.
...
#### Got a comment? [Send me an email!](https://myzopotamia.dev/cdn-cgi/l/email-protection#2b4652514e4012196b4c464a42470548444614585e49414e485f166947444c0e191b684446464e455f110e191b045f594a4e4d424006594e5d4e59584e065b59445352065c425f43064844455f4a42454e5958)