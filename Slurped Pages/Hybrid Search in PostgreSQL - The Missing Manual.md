---
link: https://www.paradedb.com/blog/hybrid-search-in-postgresql-the-missing-manual
date: 2025-10-22T02:00
excerpt: Build production-ready hybrid search that combines BM25 lexical matching with vector similarity search, all inside PostgreSQL
tags:
  - postgresql
  - pgvector
  - search
  - bm25
slurped: 2026-02-22T16:20
...
To add pgvector to your Postgres instance check out their [installation instructions](https://github.com/pgvector/pgvector?tab=readme-ov-file#installation). If you're using the [ParadeDB Docker image](https://docs.paradedb.com/deploy/self-hosted/docker) then pgvector will be installed and ready to go.
