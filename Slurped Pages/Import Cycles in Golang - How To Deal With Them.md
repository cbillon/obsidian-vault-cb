---
link: https://jogendra.dev/import-cycles-in-golang-and-how-to-deal-with-them
byline: Jogendra
site: Jogendra
date: 2021-01-03T01:00
excerpt: Post explaining how the Import Cycles in Golang occurs and how you can deal with them
tags:
  - go
  - import
slurped: 2025-10-05T18:00
...
- **Direct Cycle:** Package `p1` imports `p2`, and `p2` imports `p1`. This forms a direct cycle of dependency. The problem can also be more complex, involving multiple packages in a chain:
...
![import cycle golang](https://user-images.githubusercontent.com/20956124/103145320-6c099f80-475e-11eb-8d24-9112b5e23dee.png)
...
### ![:hammer_and_wrench:](https://github.githubassets.com/images/icons/emoji/unicode/1f6e0.png ":hammer_and_wrench:") Debugging Import Cycles
...
![import cycle golang](https://user-images.githubusercontent.com/20956124/103155444-0f41cf80-47c6-11eb-9ae8-791310e10b0a.png)
...
Interestingly, you can avoid importing package by making use of `go:linkname`. `go:linkname` is compiler directive (used as `//go:linkname localname [importpath.name]`). This special directive does not apply to the Go code that follows it. Instead, the _//go:linkname_ directive instructs the compiler to use _“importpath.name”_ as the object file symbol name for the variable or function declared as _“localname”_ in the source code. (definition from [golang.org](https://golang.org/cmd/compile/#hdr-Compiler_Directives), hard to understand at first sight, look at the source code link below, I tried solving import cycle using it.)
