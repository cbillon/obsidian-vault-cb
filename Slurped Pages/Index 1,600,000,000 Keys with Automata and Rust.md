---
link: https://burntsushi.net/transducers/
excerpt: I blog mostly about my own programming projects.
tags:
  - automata
slurped: 2026-01-01T10:25
...
This article is quite long, so if you only came for the fan fare, then you may skip straight to the [section where we index 1,600,000,000 keys](https://burntsushi.net/transducers/#common-crawl).
...
- [Finite state machines as data structures](https://burntsushi.net/transducers/#finite-state-machines-as-data-structures)
    - [Ordered sets](https://burntsushi.net/transducers/#ordered-sets)
    - [Ordered maps](https://burntsushi.net/transducers/#ordered-maps)
    - [Construction](https://burntsushi.net/transducers/#construction)
        - [Trie construction](https://burntsushi.net/transducers/#trie-construction)
        - [FSA construction](https://burntsushi.net/transducers/#fsa-construction)
        - [FST construction](https://burntsushi.net/transducers/#fst-construction)
        - [Construction in practice](https://burntsushi.net/transducers/#construction-in-practice)
        - [References](https://burntsushi.net/transducers/#references)
- [The FST library](https://burntsushi.net/transducers/#the-fst-library)
    - [Building ordered sets and maps](https://burntsushi.net/transducers/#building-ordered-sets-and-maps)
        - [A builder shortcut](https://burntsushi.net/transducers/#a-builder-shortcut)
    - [Querying ordered sets and maps](https://burntsushi.net/transducers/#querying-ordered-sets-and-maps)
    - [Memory maps](https://burntsushi.net/transducers/#memory-maps)
    - [Levenshtein automata](https://burntsushi.net/transducers/#levenshtein-automata)
    - [Levenshtein automata and Unicode](https://burntsushi.net/transducers/#levenshtein-automata-and-unicode)
    - [Regular expressions](https://burntsushi.net/transducers/#regular-expressions)
    - [Set operations](https://burntsushi.net/transducers/#set-operations)
    - [Raw transducers](https://burntsushi.net/transducers/#raw-transducers)
- [The FST command line tool](https://burntsushi.net/transducers/#the-fst-command-line-tool)
    - [How to get it](https://burntsushi.net/transducers/#how-to-get-it)
    - [Brief introduction](https://burntsushi.net/transducers/#brief-introduction)
    - [Experiments](https://burntsushi.net/transducers/#experiments)
        - [The dictionary](https://burntsushi.net/transducers/#the-dictionary)
        - [Gutenberg](https://burntsushi.net/transducers/#gutenberg)
        - [Wikipedia titles](https://burntsushi.net/transducers/#wikipedia-titles)
        - [DOI urls](https://burntsushi.net/transducers/#doi-urls)
        - [Common crawl](https://burntsushi.net/transducers/#common-crawl)
        - [Query performance](https://burntsushi.net/transducers/#query-performance)
- [Lessons and trade offs](https://burntsushi.net/transducers/#lessons-and-trade-offs)
    - [Not a general purpose data structure](https://burntsushi.net/transducers/#not-a-general-purpose-data-structure)
    - [More useful on 64 bit systems](https://burntsushi.net/transducers/#more-useful-on-64-bit-systems)
    - [Requires fast random access](https://burntsushi.net/transducers/#requires-fast-random-access)
- [Conclusion](https://burntsushi.net/transducers/#conclusion)
...
![The daily life of my cat Cauchy](https://burntsushi.net/images/transducers/dot/cauchy.png)
...
![A set with one element, FSA](https://burntsushi.net/images/transducers/sets/set1.png)
...
![A set with two elements, FSA](https://burntsushi.net/images/transducers/sets/set2.png)
...
![A set with three elements, FSA](https://burntsushi.net/images/transducers/sets/set3.png)
...
FSA](https://burntsushi.net/images/transducers/sets/set3-suffixes.png)
...
![A map with one element, FST](https://burntsushi.net/images/transducers/maps/map1.png)
...
![A map with two elements, FST](https://burntsushi.net/images/transducers/maps/map2.png)
...
![A map with three elements, FST](https://burntsushi.net/images/transducers/maps/map3.png)
...
FST](https://burntsushi.net/images/transducers/maps/map2-suffixes.png)
...
![Set of first three days of week, FSA](https://burntsushi.net/images/transducers/sets/days3.png)

And here is the corresponding trie, which only shares prefixes:

![Set of first three days of week, Trie](https://burntsushi.net/images/transducers/dot/days3-trie.png)
...
![FSA construction, step 1](https://burntsushi.net/images/transducers/dot/days3-fsa-1.png)

This isn’t so interesting. Here’s what happens when we insert `thurs`:

![FSA construction, step 2](https://burntsushi.net/images/transducers/dot/days3-fsa-2.png)
...
![FSA construction, step 3](https://burntsushi.net/images/transducers/dot/days3-fsa-3.png)
...
![FSA construction, step 4](https://burntsushi.net/images/transducers/dot/days3-fsa-4.png)
...
![FSA construction, step 5](https://burntsushi.net/images/transducers/dot/days3-fsa-5.png)
...
![FST construction, step 1](https://burntsushi.net/images/transducers/dot/days3-fst-1.png)
...
![FST construction, step 1, alternate](https://burntsushi.net/images/transducers/dot/days3-fst-1-alt.png)
...
![FST construction, step 2](https://burntsushi.net/images/transducers/dot/days3-fst-2.png)
...
![FST construction, step 3](https://burntsushi.net/images/transducers/dot/days3-fst-3.png)
...
![FST construction, step 4](https://burntsushi.net/images/transducers/dot/days3-fst-4.png)
...
![FST construction, step 5](https://burntsushi.net/images/transducers/dot/days3-fst-5.png)
...
(If you aren’t familiar with Rust, you’re probably wondering: what the heck is that `?` thing? Well, in short, it’s an operator that uses early returns and polymorphism to handle errors for us. The best way to think of it is: every time you see `?`, it means the underlying operation may fail, and if it does, return the error value and stop executing the current function. See my [other blog post on error handling in Rust](https://burntsushi.net/rust-error-handling) for more details.
...
![A map with all month abbreviations](https://burntsushi.net/images/transducers/maps/months.png)
