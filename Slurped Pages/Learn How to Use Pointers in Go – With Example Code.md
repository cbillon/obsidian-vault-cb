---
link: https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/
byline: Gabor Koos
site: freeCodeCamp.org
date: 2025-10-06T16:04
excerpt: |-
...
- [Prerequisites](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-prerequisites)
    
- [What is a Pointer?](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-what-is-a-pointer)
    
    - [Understanding Memory](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-understanding-memory)
        
    - [Stack vs Heap](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-stack-vs-heap)
        
    - [The Pointer](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-the-pointer)
        
- [Declaring and Using Pointers](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-declaring-and-using-pointers)
    
    - [Pointers to Basic Types](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-pointers-to-basic-types)
        
    - [Getting an Address with &](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-getting-an-address-with-amp)
        
    - [Pointers to Structs](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-pointers-to-structs)
        
    - [Pointers to Other User Types](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-pointers-to-other-user-types)
        
- [Why Use Pointers?](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-why-use-pointers)
    
    - [Avoiding Copies](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-avoiding-copies)
        
    - [Sharing and Mutating State](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-sharing-and-mutating-state)
        
    - [Method Receivers](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-method-receivers)
        
    - [Interfacing with Low-Level APIs](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-interfacing-with-low-level-apis)
        
- [Common Pitfalls and Misunderstandings](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-common-pitfalls-and-misunderstandings)
    
    - [Nil Pointers](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-nil-pointers)
        
    - [Reference Types](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-reference-types)
        
- [Pointer Receivers](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-pointer-receivers)
    
    - [Value Receivers vs Pointer Receivers](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-value-receivers-vs-pointer-receivers)
        
    - [Idiomatic Go](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-idiomatic-go)
        
- [Exercises for the Reader](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-exercises-for-the-reader)
    
- [Bonus: Weak Pointers (Go 1.24+)](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-bonus-weak-pointers-go-124)
    
    - [What Are Weak Pointers?](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-what-are-weak-pointers)
        
    - [When to Use Weak Pointers?](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-when-to-use-weak-pointers)
        
- [Summary & Best Practices](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-summary-amp-best-practices)
    
- [Solutions to Exercises](https://www.freecodecamp.org/news/learn-how-to-use-pointers-in-go-with-example-code/#heading-solutions-to-exercises)
...
1. In a _type declaration_ (like `var p *int32`), `*` indicates that `p` is a pointer to an `int32`.
    
2. In an _expression_ (like `*p`), `*` dereferences the pointer, giving you access to the value it points to.
