---
link: https://www.quasilyte.dev/blog/post/pratt-parsers-go/
byline: Iskander Sharipov
excerpt: Technical blog about systems programming and related topics
slurped: 2025-10-18T11:43
title: Let's Go write Pratt parsers! · Iskander (Alex) Sharipov technical blog
tags:
  - go
  - parser
---

If you found a typo or a misspelling, please [file an issue](https://github.com/quasilyte/blog-src/issues/new) or send a PR that fixes it.

> Original (ru): [https://habr.com/ru/post/494316/](https://habr.com/ru/post/494316/).
...
> The example above can handle errors in at least 2 ways. I tend to use `panic+recover` in parsers, but you can use `{exprNode, error}` return values and handle errors more traditionally. If you choose the `panic` approach, don’t forget to `recover` inside your parser entry method and return parsing error as a value.
