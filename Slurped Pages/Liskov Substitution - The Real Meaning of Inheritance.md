---
link: https://cekrem.github.io/posts/liskov-substitution-the-real-meaning-of-inheritance/
byline: Christian Ekrem
site: cekrem.github.io
date: 2025-01-21T01:00
excerpt: Part 3 of our Clean Architecture series, exploring the 'L' in SOLID
tags:
  - solid
  - liskov
slurped: 2025-10-18T11:48
...
After exploring [Dependency Inversion](app://obsidian.md/posts/clean-architecture-and-plugins-in-go) and [Interface Segregation](app://obsidian.md/posts/interface-segregation-in-practice), let’s tackle perhaps the most misunderstood principle of SOLID: The Liskov Substitution Principle (LSP).
...
## The Classic Rectangle-Square Problem [Link to heading](#the-classic-rectangle-square-problem)
...
## A Better Approach [Link to heading](#a-better-approach)
...
## Real-World Example: Payment Processing [Link to heading](#real-world-example-payment-processing)
...
## Common LSP Violations [Link to heading](#common-lsp-violations)

### 1. Throwing Unexpected Exceptions [Link to heading](#1-throwing-unexpected-exceptions)
...
### 2. Returning Null When Base Type Doesn’t [Link to heading](#2-returning-null-when-base-type-doesnt)
...
## How to Ensure LSP Compliance [Link to heading](#how-to-ensure-lsp-compliance)
