---
link: https://myzopotamia.dev/manage-your-secrets-with-sops-and-gpg
byline: Radosław Skupnik
excerpt: When self-hosting, it is not uncommon to come across some secrets that should not be stored as open text. Often times...
slurped: 2026-06-04T09:21
...
You can now use it with sops. For example, to encrypt the entire file, run: `sops --encrypt --gpg <[[email protected]](https://myzopotamia.dev/cdn-cgi/l/email-protection)> docker-compose.yaml > docker-compose.encrypted.yaml`. To decrypt, just run `sops --decrypt docker-compose.encrypted.yaml > docker-compose.yaml`
