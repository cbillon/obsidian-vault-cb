---
link: https://blog.eleven-labs.com/fr/organiser-son-pipeline-gitlab-ci-avec-les-templates/
byline: Thierry T.
site: Eleven Labs
date: 2022-04-26T02:00
excerpt: Lorsqu'il y a plusieurs services à maintenir et à déployer, le code des
  pipelines des différents services est très souvent copié-collé. Nous verrons
  dans cet article comment mutualiser le code !
slurped: 2026-08-23T08:29
...
Tous les templates dont nous avons besoin pour transformer le pipeline seront inclus via le mot clef `include`. Avec l'option `ref`, les templates sont versionnés. Un outil tel que [renovate](https://docs.renovatebot.com/) pourra faire des MR de mise à jour de la version.
