...
byline: Julia Evans
site: Julia Evans
excerpt: Popular git config options
slurped: 2025-11-02T11:38
...
- [pull.ff only or pull.rebase true](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#pull-ff-only-or-pull-rebase-true)
- [merge.conflictstyle zdiff3](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#merge-conflictstyle-zdiff3)
- [rebase.autosquash true](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#rebase-autosquash-true)
- [rebase.autostash true](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#rebase-autostash-true)
- [push.default simple, push.default current](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#push-default-simple-push-default-current)
- [init.defaultBranch main](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#init-defaultbranch-main)
- [commit.verbose true](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#commit-verbose-true)
- [rerere.enabled true](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#rerere-enabled-true)
- [help.autocorrect 10](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#help-autocorrect-10)
- [core.pager delta](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#core-pager-delta)
- [diff.algorithm histogram](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#diff-algorithm-histogram)
- [core.excludesfile ~/.gitignore](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#core-excludesfile-a-global-gitignore)
- [includeIf: separate git configs for personal and work](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#includeif-separate-git-configs-for-personal-and-work)
- [fsckobjects: avoid data corruption](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#fsckobjects-avoid-data-corruption)
- [submodule stuff](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#submodule-stuff)
- [and more](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#and-more)
- [how to set these](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#how-to-set-these)
- [config changes I’ve made after writing this post](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#config-changes-i-ve-made-after-writing-this-post)
...
### [`push.default simple`, `push.default current`, `push.autoSetupRemote true`](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#push-default-simple-push-default-current-push-autosetupremote-true)
...
### [`core.excludesfile`: a global .gitignore](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#core-excludesfile-a-global-gitignore)
...
### [`url."git@github.com:".insteadOf 'https://github.com/'`](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#url-git-github-com-insteadof-https-github-com)
...
### [that’s all!](https://jvns.ca/blog/2024/02/16/popular-git-config-options/#that-s-all)
