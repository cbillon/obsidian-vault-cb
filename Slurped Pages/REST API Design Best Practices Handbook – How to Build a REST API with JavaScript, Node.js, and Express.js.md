...
date: 2022-05-04T17:10
excerpt: >-
  By Jean-Marc Möckel

  I've created and consumed many API's over the past few years. During that
  time, I've come across good and bad practices and have experienced nasty
  situations when consuming and building API's. But there also have been great
  moment...
twitter: https://twitter.com/@freecodecamp
slurped: 2025-12-17T09:45
title: REST API Design Best Practices Handbook – How to Build a REST API with
...
- [Our Example Project](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-our-example-project)
    - [Prerequisites](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-prerequisites)
    - [Architecture](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-architecture)
    - [Basic Setup](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-basic-setup)
- [REST API Best Practices](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-rest-api-best-practices)
    - [Versioning](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-versioning)
    - [Name resources in plural](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-name-resources-in-plural)
    - [Accept and respond with data in JSON format](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-accept-and-respond-with-data-in-json-format)
    - [Respond with standard HTTP Error Codes](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-respond-with-standard-http-error-codes)
    - [Avoid verbs in endpoint names](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-avoid-verbs-in-endpoint-names)
    - [Group associated resources together](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-group-associated-resources-together-logical-nesting)
    - [Integrate filtering, sorting & pagination](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-integrate-filtering-sorting-amp-pagination)
    - [Use data caching for performance improvements](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-use-data-caching-for-performance-improvements)
    - [Good security practices](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-good-security-practices)
    - [Document your API properly](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-document-your-api-properly)
- [Conclusion](https://www.freecodecamp.org/news/rest-api-design-best-practices-build-a-rest-api/#heading-conclusion)
...
![Image](https://www.freecodecamp.org/news/content/images/2022/04/constantin-wenning-idDvA4jPBO8-unsplash--1-.jpg) _Photo by [Unsplash](https://unsplash.com/@conniwenningsimages?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Constantin Wenning on <a href="https://unsplash.com/s/photos/handshake?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText)_
