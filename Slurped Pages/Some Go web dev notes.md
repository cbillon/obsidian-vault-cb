...
byline: Julia Evans
site: Julia Evans
excerpt: Some Go web dev notes
slurped: 2025-10-23T11:13
...
### [go 1.22 now has better routing](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#go-1-22-now-has-better-routing)
...
### [a gotcha with the built-in router: redirects with trailing slashes](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#a-gotcha-with-the-built-in-router-redirects-with-trailing-slashes)

One annoying gotcha I ran into was: if I make a route for `/records/`, then a request for `/records` [will be redirected](https://pkg.go.dev/net/http#hdr-Trailing_slash_redirection-ServeMux) to `/records/`.

I ran into an issue with this where sending a POST request to `/records` redirected to a GET request for `/records/`, which broke the POST request because it removed the request body. Thankfully [Xe Iaso wrote a blog post about the exact same issue](https://xeiaso.net/blog/go-servemux-slash-2021-11-04/) which made it easier to debug.
...
### [sqlc automatically generates code for my db queries](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#sqlc-automatically-generates-code-for-my-db-queries)
...
### [sqlite tips](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#sqlite-tips)
...
### [Go 1.19 introduced a way to set a GC memory limit](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#go-1-19-introduced-a-way-to-set-a-gc-memory-limit)
...
### [some reasons I like making websites in Go](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#some-reasons-i-like-making-websites-in-go)
...
### [things I haven’t figured out yet](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#things-i-haven-t-figured-out-yet)
...
### [it’s cool to see the new features Go has been adding](https://jvns.ca/blog/2024/09/27/some-go-web-dev-notes/#it-s-cool-to-see-the-new-features-go-has-been-adding)
