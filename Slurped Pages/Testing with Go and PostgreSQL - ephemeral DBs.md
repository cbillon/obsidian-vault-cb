---
link: https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/
...
excerpt: >-
  ...
  Docker container, for example, or do you maybe reuse your development
  PostgreSQL instance?
slurped: 2026-04-08T14:43
title: "Testing with Go and PostgreSQL: ephemeral DBs"
---

Table of contents

- [Single-package tests](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#single-package-tests)
- [go test process model](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#go-test-process-model)
- [Sharing one PostgreSQL among all tests](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#sharing-one-postgresql-among-all-tests)
    - [Running the initpg wrapper program](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#running-the-initpg-wrapper-program)
- [Performance](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#performance)
    - [Why is it sometimes slower?](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#why-is-it-sometimes-slower)
    - [Fixing Go test caching (env vars)](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#fixing-go-test-caching-env-vars)
- [Conclusion](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#conclusion)
- [Further optimization potential](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#further-optimization-potential)
    - [Hide Postgres startup](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#hide-postgres-startup)
    - [De-duplicate schema creation cost](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/#de-duplicate-schema-creation-cost)

[![PostgreSQL elephant logo](https://michael.stapelberg.ch/posts/2024-11-19-testing-with-go-and-postgresql-ephemeral-dbs/postgresql-elephant-featured.png)](https://en.wikipedia.org/wiki/PostgreSQL)
...
That’s not _terrible_, but not great either.
