---
link: https://github.com/diogopessoa/ubuntu-btrfs-install
site: GitHub
excerpt: Ubuntu Installation with Btrfs  and automatic snapshots - diogopessoa/ubuntu-btrfs-install
twitter: https://twitter.com/@github
slurped: 2026-05-25T20:57
title: "GitHub - diogopessoa/ubuntu-btrfs-install: Ubuntu Installation with Btrfs  and automatic snapshots"
tags:
  - ubuntu
  - btrfs
  - install
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#what-the-script-does)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#requirements)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#install-ubuntu-with-btrfs)

This guide uses Ubuntu 25.04 as an example.

### Step-by-Step Guide

[](https://github.com/diogopessoa/ubuntu-btrfs-install#step-by-step-guide)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#how-to-use-the-script)

⚠️ **After installing Ubuntu with Btrfs, do not reboot!**

### Identify Your Partitions

[](https://github.com/diogopessoa/ubuntu-btrfs-install#identify-your-partitions)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#download-the-script-to-the-live-session)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#make-it-executable)

chmod +x ubuntu-btrfs-install.sh

### Run the Script

[](https://github.com/diogopessoa/ubuntu-btrfs-install#run-the-script)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#-done)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#-manual-installation-of-snapper-and-btrfs-assistant-post-installation)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#automatic-snapshots-configuration)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#-done-your-system-now-has-snapshots-automatically)

### Screenshots

[](https://github.com/diogopessoa/ubuntu-btrfs-install#screenshots)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#license)
...
[](https://github.com/diogopessoa/ubuntu-btrfs-install#credits)
