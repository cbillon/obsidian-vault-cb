---
link: https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client
byline: La team Rix
site: rix
date: 2023-01-02T00:00
excerpt: Apprendre à utiliser le fichier de configuration SSH pour organiser ses options de connexion.
slurped: 2025-11-26T13:02
...
## [Pré-requis](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#pre-requis)

Ils sont plus que pauvre puisqu'un client OpenSSH et une machine distante à laquelle se connecter suffiront.

## [TL;DR](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#tl-dr)
...
## [Pourquoi utiliser un fichier de configuration ?](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#pourquoi-utiliser-un-fichier-de-configuration)
...
## [Le fichier de configuration](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#le-fichier-de-configuration)
...
## [Les instructions de configuration](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#les-instructions-de-configuration)
...
## [Priorité des instructions](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#priorite-des-instructions)
...
## [Séparer et inclure ses fichiers de configuration](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#separer-et-inclure-ses-fichiers-de-configuration)
...
## [Les instructions les plus courantes / utiles](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#les-instructions-les-plus-courantes-utiles)

Le fichier `config` supporte nombre d'options de configuration, celles-ci sont consultables [ici](https://linux.die.net/man/5/ssh_config). Il va de soi que dans l'activité quotidienne, les mêmes instructions sont souvent utilisées, ci-dessous une liste des plus courantes:
...
## [Multiplexer ses connexions SSH](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#multiplexer-ses-connexions-ssh)
...
### [Exemple de fichiers de configuration avec multiplexage](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#exemple-de-fichiers-de-configuration-avec-multiplexage)
...
On remarquera son utilisation dans l'exemple ci-dessus. Il s'agit du **hash [SHA1](https://en.wikipedia.org/wiki/SHA-1)** des tokens %l%h%p%r (Respectivement le nom d'hôte local (`%l`), le nom d'hôte distant (`%h`), le port de connexion distant (`%p`) et pour finir le nom d'utilisateur distant utilisé (`%r`)). L'utilisation du token `%C` assurant à la fois, l'unicité de la connexion et l'obfuscation de ses détails sur le système de fichiers.

## [Aller plus loin avec les sources](https://www.rix.fr/blog/cours/utiliser-la-configuration-ssh-client#aller-plus-loin-avec-les-sources)
...
- [https://man.openbsd.org/ssh_config](https://man.openbsd.org/ssh_config)
- [https://unix.stackexchange.com/a/89149](https://unix.stackexchange.com/a/89149)
...
- [https://www.quora.com/What-is-the-controlpersist-feature-Unix](https://www.quora.com/What-is-the-controlpersist-feature-Unix)
