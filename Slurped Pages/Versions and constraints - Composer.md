---
link: https://getcomposer.org/doc/articles/versions.md#writing-version-constraints
excerpt: A Dependency Manager for PHP
slurped: 2025-12-14T16:41
title: Versions and constraints - Composer
tags:
  - composer
  - version
  - constraints
...
- [Composer Versions vs VCS Versions](https://getcomposer.org/doc/articles/versions.md#composer-versions-vs-vcs-versions)
- [VCS Tags and Branches](https://getcomposer.org/doc/articles/versions.md#vcs-tags-and-branches)
    - [Tags](https://getcomposer.org/doc/articles/versions.md#tags)
    - [Branches](https://getcomposer.org/doc/articles/versions.md#branches)
    - [Stabilities](https://getcomposer.org/doc/articles/versions.md#stabilities)
    - [Minimum Stability](https://getcomposer.org/doc/articles/versions.md#minimum-stability)
- [Writing Version Constraints](https://getcomposer.org/doc/articles/versions.md#writing-version-constraints)
    - [Exact Version Constraint](https://getcomposer.org/doc/articles/versions.md#exact-version-constraint)
    - [Version Range](https://getcomposer.org/doc/articles/versions.md#version-range)
    - [Hyphenated Version Range (-)](https://getcomposer.org/doc/articles/versions.md#hyphenated-version-range-)
    - [Wildcard Version Range (.*)](https://getcomposer.org/doc/articles/versions.md#wildcard-version-range-)
- [Next Significant Release Operators](https://getcomposer.org/doc/articles/versions.md#next-significant-release-operators)
    - [Tilde Version Range (~)](https://getcomposer.org/doc/articles/versions.md#tilde-version-range-)
    - [Caret Version Range (^)](https://getcomposer.org/doc/articles/versions.md#caret-version-range-)
- [Stability Constraints](https://getcomposer.org/doc/articles/versions.md#stability-constraints)
- [Summary](https://getcomposer.org/doc/articles/versions.md#summary)
- [Testing Version Constraints](https://getcomposer.org/doc/articles/versions.md#testing-version-constraints)
...
_For the following discussion, let's assume the following sample library repository:_
...
> **Note:** Be careful when using unbounded ranges as you might end up unexpectedly installing versions that break backwards compatibility. Consider using the [caret](https://getcomposer.org/doc/articles/versions.md#caret-version-range-) operator instead for safety.
...
To allow various stabilities without enforcing them at the constraint level however, you may use [stability-flags](https://getcomposer.org/doc/04-schema.md#package-links) like `@<stability>` (e.g. `@dev`) to let Composer know that a given package can be installed in a different stability than your default minimum-stability setting. All available stability flags are listed on the minimum-stability section of the [schema page](https://getcomposer.org/doc/04-schema.md#minimum-stability).
...
Found a typo? Something is wrong in this documentation? [Fork and edit](https://github.com/composer/composer/edit/main/doc/articles/versions.md "Go to the docs to fork and propose updates (external link)") it!