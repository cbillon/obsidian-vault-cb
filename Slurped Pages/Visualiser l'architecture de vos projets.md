---
link: https://blog.eleven-labs.com/fr/visualiser-l-architecture-de-vos-projets/
byline: Guillem Canal
site: Eleven Labs
date: 2019-12-12T01:00
excerpt: Visualiser l'architecture de vos projets
slurped: 2026-08-23T08:37
...
[![Vidéo Youtube: UML, Cucumber and modeling reality - MPJ's Musings - Fun Fun Function](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/just-use-a-whiteboard.png)](https://www.youtube.com/watch?v=4_SvuUYQ5Fo) _[UML, Cucumber and modeling reality - MPJ's Musings - Fun Fun Function](https://www.youtube.com/watch?v=4_SvuUYQ5Fo) par [Mattias Petter Johansson (mpj)](https://twitter.com/mpjme)_

L'approche semble valable de prime abord, malheureusement, on peut aboutir rapidement à ce résultat :

![Exemple de diagramme d'architecture problématique](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/diagramme-bordelique.jpg)
...
Le modèle C4, créé par [Simon Brown](https://simonbrown.je/), vise a aider les équipes à **décrire** et **communiquer** l'architecture logicielle, lors des sessions de conception _(up-front design)_, ainsi que rétrospectivement, pendant les phases de documentation, grâce à une notation semi-formelle accessible au plus grand nombre.
...
![Illustration des 4 niveaux de zooms du modèle C4](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/c4model-layered.svg)
...
![Le professeur Dumbledore utilisant un sort d'extraction de souvenirs](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/dumbledore_memory.jpg)
...
![Filtrage du modèle d'architecture pour obtenir une vue correspondant à la question posée](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/c4model-filter.svg)
...
![Hiérarchie des éléments d'architecture du modèle C4](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/hierarchy.png)
...
![Notation du modèle C4](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/notation.png)
...
![Modèle C4: Vue Contexte Système](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/system-context.png)
...
![Modèle C4: Vue Conteneur](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/containers.png)

Une fois que l'on situe un système dans son environnement, la prochaine étape est de zoomer dans les frontières de ce dernier _(system boundaries)_ pour matérialiser les conteneurs qui le composent.
...
![Modèle C4: Vue Composant](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/component.png)
...
![Modèle C4: Vue Code](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/code.png)
...
![Modèle C4: Paysage Applicatif](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/landscape.png)
...
![Modèle C4: Plan de Déploiement](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/deployment.png)
...
![Logo Structurizr](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/structurizr-logo.png)

![Structurizr: Ajouter des éléments](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/structiruzr-edit-elements.gif) _Ajout d'éléments via l'interface Structurizr_

![Structurizr: éditeur de styles](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/structurizr-edit-styles.png) _Édition des styles via l'interface Structurizr_

![Structurizr: éditeur de styles](https://blog.eleven-labs.com/imgs/articles/2019-12-12-visualiser-l-architecture-de-vos-projets/structurizr-edit-views.png) _Création de vues via l'interface Structurizr_
