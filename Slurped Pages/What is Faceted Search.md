---
link: https://www.paradedb.com/learn/search-concepts/faceting
date: 2024-10-31T01:00
excerpt: Learn about faceting and faceted search, how they relate to aggregations, and when to use them.
tags:
  - search
  - faceted_search
slurped: 2026-02-22T17:34
title: What is Faceted Search?
---

**Faceted search**, also known as faceting, is a [search technique](https://en.wikipedia.org/wiki/Faceted_search) that organizes [full-text search](https://www.paradedb.com/learn/search-concepts/full-text-search) results into filterable categories, known as _facets_. Each facet represents a property of the data (such as color, brand, or price range) and lets users narrow down large result sets by selecting multiple values simultaneously. It’s the foundation of interactive filtering in e-commerce, document search, and analytics platforms.
