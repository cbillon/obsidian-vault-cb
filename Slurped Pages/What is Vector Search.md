---
link: https://www.paradedb.com/learn/search-concepts/vector-search
date: 2024-10-06T02:00
excerpt: Learn about vector search, how it enables semantic similarity matching using high-dimensional embeddings.
tags:
  - pgvector
  - postgresql
slurped: 2026-02-22T17:32
title: What is Vector Search?
---

Vector search, also known as similarity search and semantic search, focuses on finding similar content based on semantic meaning rather than exact keyword matches. Unlike traditional [full-text search](https://www.paradedb.com/learn/search-concepts/full-text-search) that asks "which documents contain these tokens?", vector search asks "which documents mean something similar to this?"
...
Vector search requires more storage and compute resources than traditional search. Even at query time, generating embeddings and computing similarity scores can add noticeable latency compared to [BM25](https://www.paradedb.com/learn/search-concepts/bm25).

In many scenarios, **[hybrid search](https://www.paradedb.com/learn/search-concepts/hybrid-search)** approaches that combine both vector and traditional [full-text search](https://www.paradedb.com/learn/search-concepts/full-text-search) often provide the best solution:
...
- Ranking algorithms like [Reciprocal Rank Fusion](https://www.paradedb.com/learn/search-concepts/reciprocal-rank-fusion) that blend both approaches for optimal relevance
