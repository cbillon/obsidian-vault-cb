---
link: https://github.com/azlux/log2ram#existing-content-in-varlog-too-large-for-ram
byline: azlux
site: GitHub
excerpt: ramlog like for systemd (Put log into a ram folder) - azlux/log2ram
twitter: https://twitter.com/@github
slurped: 2025-07-01T12:58
title: "GitHub - azlux/log2ram: ramlog like for systemd (Put log into a ram folder)"
tags:
  - linux
  - log
  - ram
...
[](https://github.com/azlux/log2ram#log2ram)
...
[](https://github.com/azlux/log2ram#table-of-contents)

1. [Installation](https://github.com/azlux/log2ram#installation)
2. [Is it working?](https://github.com/azlux/log2ram#is-it-working)
3. [Upgrading](https://github.com/azlux/log2ram#upgrading)
4. [Customization](https://github.com/azlux/log2ram#customization)
5. [Troubleshooting](https://github.com/azlux/log2ram#troubleshooting)
6. [Uninstallation](https://github.com/azlux/log2ram#uninstallation-)

## Installation

[](https://github.com/azlux/log2ram#installation)
...
[](https://github.com/azlux/log2ram#manually)
...
[](https://github.com/azlux/log2ram#is-it-working)
...
If you do not get any line as response of these commands, something is not working. Refer to [this section](https://github.com/azlux/log2ram#is-it-working).

## Upgrading

[](https://github.com/azlux/log2ram#upgrading)

You need to stop Log2Ram (`systemctl stop log2ram`) and execute the [installation](https://github.com/azlux/log2ram#installation) process. If you used APT, this will be done automatically.

## Customization

[](https://github.com/azlux/log2ram#customization)

#### Variables

[](https://github.com/azlux/log2ram#variables)
...
- `JOURNALD_AWARE`: enable log rotation for journald logs before syncing. (default is `true`). Check the comment in the config file or the [Troubleshooting](https://github.com/azlux/log2ram#Troubleshooting) section below for journald SystemMaxUse recommendations.
- `ZL2R`: enable zram compatibility (`false` by default). Check the comment in the config file. See [https://github.com/StuartIanNaylor/zram-swap-config](https://github.com/StuartIanNaylor/zram-swap-config) to configure a zram space on your raspberry before enabling this option.
- `COMP_ALG`: choose a compression algorithm from those listed in /proc/crypto. (default is `lz4`). See [Compressor](https://github.com/azlux/log2ram#Compressor) section below for options.
- `LOG_DISK_SIZE`: specifies the uncompressed zram disk size

#### Refresh time

[](https://github.com/azlux/log2ram#refresh-time)
...
[](https://github.com/azlux/log2ram#now-muffins-for-everyone)

## Troubleshooting

[](https://github.com/azlux/log2ram#troubleshooting)

### Existing content in `/var/log` too large for RAM

[](https://github.com/azlux/log2ram#existing-content-in-varlog-too-large-for-ram)
...
[](https://github.com/azlux/log2ram#uninstallation-)

(Because sometimes we need it)

### Via APT

[](https://github.com/azlux/log2ram#via-apt)

You can add the `--purge` argument to remove Log2Ram config files as well.

### Manually

[](https://github.com/azlux/log2ram#manually-1)
