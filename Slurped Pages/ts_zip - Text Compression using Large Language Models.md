---
link: https://bellard.org/ts_zip/
excerpt: Text compression using AI LLM Fabrice Bellard.
slurped: 2026-06-21T16:11
...
- See also [ts_sms](https://bellard.org/ts_sms) which is optimized for the compression of small messages.

## Compression Ratio

The compression ratio is given in bits per byte (bpb).

|File|Original size  <br>(bytes)|[xz](https://en.wikipedia.org/wiki/XZ_Utils)  <br>(bytes) (bpb)|   |ts_zip  <br>(bytes) (bpb)|   |
|---|---|---|---|---|---|
...
- Linux version: [ts_zip-2024-03-02.tar.gz](https://bellard.org/ts_zip/ts_zip-2024-03-02.tar.gz).
- Windows version: [ts_zip-2024-03-02-win64.zip](https://bellard.org/ts_zip/ts_zip-2024-03-02-win64.zip).
