...
summary: 'Abstracting away the complexity of payments has driven the evolution of our APIs over the last decade. Learn more about Stripe payments APIs here.'
authors:
  - 'Michelle Bu'
date: '2020-12-15'
topics:
...
![Payment API design](https://stripe.dev/images/payment-api-design/image-0.svg)

![blog-payment-api-design-screenshot](/images/payment-api-design/image-0.jpg)
...
![payment api diagram 1](/images/payment-api-design/image-1.svg)
...
| --- | --- | --- |
| **No customer action required** <br/> To initiate money movement | <ul><li>Card</li></ul> | <ul><li>ACH debit (days) `New`</li></ul> |
| **Customer action required** <br/>To initiate money movement |  | <ul><li>Bitcoin (hours) `New`</li></ul> |
...
![payment api diagram 2](/images/payment-api-design/image-2.svg)
...
![payment api diagram 3](/images/payment-api-design/image-3.svg)
...
|  | Payment is immediately finalized | Payment is finalized later |
| --- | --- | --- |
| **No customer action required** <br/> To initiate money movement | <ul><li>Cards</li></ul> | <ul><li>ACH debit</li><li>SEPA direct debit `New`</li><li>Bacs debit `New`</li><li>BECS debit `New`</li></ul> |
| **Customer action required** <br/> To initiate money movement | <ul><li>iDEAL `New`</li><li>Alipay `New`</li><li>giropay `New`</li><li>Bancontact `New`</li><li>WeChat Pay `New`</li><li>Przelewy24 `New`</li><li>Cards with 3D Secure `New`</li></ul> | <ul><li>Bitcoin</li><li>Multibanco `New`</li><li>Paper checks `New`</li></ul> |
...
![payment api diagram 4](/images/payment-api-design/image-4.svg)
...
![payment api diagram 5](/images/payment-api-design/image-5.svg)
...
![payment api diagram 7](/images/payment-api-design/image-6.svg)
...
|  | Payment is immediately finalized | Payment is finalized later |
| --- | --- | --- |
| **No customer action required** <br/> To initiate money movement | <ul><li><svg class="ListIcon List__itemIcon" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><path d="M8 16A8 8 0 1 1 8 0a8 8 0 0 1 0 16zm0-2.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3zM8 2a1 1 0 0 0-1 1v5a1 1 0 1 0 2 0V3a1 1 0 0 0-1-1z" fill="#FF5191" fill-rule="evenodd"></path></svg> Cards</li></ul> | <ul><li>ACH debit</li><li>SEPA direct debit</li><li>Bacs debit</li><li>BECS debit</li></ul> |
| **Customer action required** <br/> To initiate money movement | <ul><li>iDEAL</li><li>Alipay</li><li>giropay</li><li>Bancontact</li><li>WeChat Pay</li><li>Przelewy24</li><li>Cards with 3D Secure</li></ul> | <ul><li>Bitcoin</li><li>Multibanco</li><li>Paper checks</li></ul> |
...
![Payments API conference room](/images/payment-api-design/image-7.jpg)

![Payments API conference room](/images/payment-api-design/image-8.jpg)
...
![payment api diagram 6](/images/payment-api-design/image-9.svg)
...
![blog-payment-api-design-diagram-before-after](/images/payment-api-design/image-10.svg)

![blog-payment-api-design-diagram-before-after](/images/payment-api-design/image-11.svg)
...
![payment api design graph 1](/images/payment-api-design/image-12.svg)
...
![payment api design graph 2](/images/payment-api-design/image-13.svg)
