...
tags:
  ...
  - performance
---
[dpbench](https://laurentsv.com/blog/2024/10/19/no-nonsense-go-package-layout.html)

# Presentation

[](https://github.com/dpbench/dpbench/blob/main/README.md#presentation)
...
[](https://github.com/dpbench/dpbench/blob/main/README.md#quick-setup-for-the-impatient)
...
[](https://github.com/dpbench/dpbench/blob/main/README.md#motivations)
...
[](https://github.com/dpbench/dpbench/blob/main/README.md#project-organization)
...
- [howtos](https://github.com/dpbench/dpbench/blob/main/howtos): explains how to proceed at the various steps of running a benchmark
- [issues](https://github.com/dpbench/dpbench/blob/main/issues): enumerates a number of well-known issues met in benchmarks and/or production, how to detect them, how to address them when possible, how to work around them if possible, or how to correct for them and/or to mention them in the results; this is quite product-centric.
- [tuning](https://github.com/dpbench/dpbench/blob/main/tuning): some optimized settings for various operating systems and/or use cases, with explanations
- [config](https://github.com/dpbench/dpbench/blob/main/config): pre-made configurations for various products in different topologies or use cases, avoiding the blank page syndrom at the beginning of a benchmark campaign
- [results](https://github.com/dpbench/dpbench/blob/main/results): some results shared by users, versioned, dated, with all required platform details
- [scripts](https://github.com/dpbench/dpbench/blob/main/scripts): scripts that help setting up a benchmark environment, collect, aggregate and process results
- [tools](https://github.com/dpbench/dpbench/blob/main/tools): links to various tools that are commonly helpful or needed to run benchmarks, with known limitations
- bin: executables from locally built embedded tools

Please start with [howtos/](https://github.com/dpbench/dpbench/blob/main/howtos).